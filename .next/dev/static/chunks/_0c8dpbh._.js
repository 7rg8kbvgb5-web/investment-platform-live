...
"[project]/lib/supabaseclient.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            async function loadData() {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseclient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('strategic_allocations').select('*');
                if (error) {
                    console.log(error);
                } else {
                    setData(data || []);
...
//# sourceMappingURL=_0c8dpbh._.js.map